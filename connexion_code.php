    ...
    if(empty($_POST['pseudo'])) {
        ...
        if(empty($_POST['mdp'])) {
            ...
            if(!$mysqli){
                ...
                $Requete = mysqli_query($mysqli,"SELECT * FROM compte WHERE identifiant_compte = '".$Pseudo."' AND mot_de_passe = '".$MotDePasse."'");//si vous avez enregistré le mot de passe en md5() il vous suffira de faire la vérification en mettant mdp = '".md5($MotDePasse)."' au lieu de mdp = '".$MotDePasse."'
